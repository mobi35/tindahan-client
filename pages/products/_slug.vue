...
<section class="text-gray-700 body-font overflow-hidden bg-white">
    ...
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div class="flex">
          ...
          <span class="title-font font-medium text-2xl text-gray-900 block" > <PriceQuantity :price="product.price" :quantity="form.quantity" /> </span>
  ...
  <div  v-for="(variations,type) in product.variations" :key="type">
              <label for="">
                <template>
                  <button return false  v-on:click="buttonSearch(variations)" :class="type" class="border-2 border-gray-300 ml-1  rounded-full w-6 h-6 focus:outline-none"></button>
                </template>
            </label>
          </div>
           ...
           <form action="" @submit.prevent="add">
            ...
            <select :value="selectedVariationId"  v-model="form.size"  @change="changed($event)">
